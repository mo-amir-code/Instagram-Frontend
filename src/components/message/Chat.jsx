    ...
    >
      <div className="flex justify-start space-x-3">
        <div className="rounded-full overflow-hidden w-[45px] h-[45px]">
          <img src={avatar} alt={username} width={"45px"} />
        </div>
      ...
      <span className={`absolute right-4 top-[32%] bg-[#3B82F6] rounded-full w-[20px] h-[20px] flex items-center justify-center text-xs font-semibold text-text-primary ${unread > 0? "scaleIn" : "scaleOut"}`}>
        {unread}
      </span>
    </div>
  );

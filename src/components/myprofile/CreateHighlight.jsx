...
const CreateHighlight = ({mode}) => {
  return (
    <div className="space-y-2">
      ...
      >
        <div className={`flex justify-center items-center rounded-full overflow-hidden ${mode === "mobile" ?"w-[50px] h-[50px]" :"w-[80px] h-[80px]"} bg-hover-primary text-text-secondary`}>
          <Plus size={mode === "mobile" ? 40: 50} />
        </div>
      </div>
      <h4 className="text-xs text-text-primary font-semibold text-center" >New</h4>
    </div>
  );
};
